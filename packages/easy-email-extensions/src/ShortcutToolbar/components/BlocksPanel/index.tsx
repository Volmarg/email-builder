...
/**
 * @description that's the special popup menu show with some extra options in it
 */
        ...
        {ele &&
          ...
          createPortal(
            <div
              ...
              data-is-blocks-panel-dragging={isDragging ? 'true' : 'false'}
              style={{
